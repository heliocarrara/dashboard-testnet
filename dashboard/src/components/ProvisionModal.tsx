...
const ProvisionModal: React.FC<ProvisionModalProps> = ({ validatorCount, onSuccess }) => {
  ...
  return (
    <div className="fixed bottom-4 right-4 bg-white p-6 rounded-lg shadow-xl border border-gray-200 z-50">
      <h3 className="text-lg font-bold mb-2 text-gray-800">Auto-Configure Core</h3>
      <p className="text-sm text-gray-600 mb-4">Current Validators: <span className="font-bold">{validatorCount}/5</span></p>
      
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-2 mb-4">
        <p className="text-xs text-yellow-700">Need at least 5 validators to launch the network.</p>
      </div>
